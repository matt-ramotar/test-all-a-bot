...
class Oauth(object):
    ...
    redirect_uri = 'http://test-all-a-bot.herokuapp.com/auth/redirect'
    discord_login_url = 'https://discord.com/api/oauth2/authorize?client_id=771154573795655680&redirect_uri=http%3A%2F%2Ftest-all-a-bot.herokuapp.com%2Fauth%2Fredirect&response_type=code&scope=identify%20email%20connections%20guilds'
